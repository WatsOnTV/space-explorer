...
/** Represents a Scavenger member type, which extends the CrewMember abstract class.
 * @author Karna Malone
 * @author Daniel Watson
*/
public class ScavengerMember extends CrewMember{
	private String type = "Scavenger";
	private int typeNum = 2;
	
	/** Initializes CrewMember with given name.
	 * @param name The name of the new CrewMember.
	*/
	public ScavengerMember(String name) {
		super(name);
	}
