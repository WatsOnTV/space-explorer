...
/** Represents a Body Builder member type, which extends the CrewMember abstract class.
 * @author Karna Malone
 * @author Daniel Watson
*/
public class BodyBuilderMember extends CrewMember{
	private String type = "Body Builder";
	private int typeNum = 3;
	
	/** Initializes CrewMember with given name.
	 * @param name The name of the new CrewMember.
	*/
	public BodyBuilderMember(String name) {
		super(name);
	}
