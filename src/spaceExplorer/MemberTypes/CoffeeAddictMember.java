...
/** Represents a Coffee Addict member type, which extends the CrewMember abstract class.
 * @author Karna Malone
 * @author Daniel Watson
*/
public class CoffeeAddictMember extends CrewMember{
	private String type = "Coffee Addict";
	private int typeNum = 5;
	
	/** Initializes CrewMember with given name.
	 * @param name The name of the new CrewMember.
	*/
	public CoffeeAddictMember(String name) {
		super(name);
	}
