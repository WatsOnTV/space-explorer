...
public class GameOverScreen {
	 ...
	 */
	public GameOverScreen(Game incomingState, String message) {
	...
	private void initialize() {
		...
		JLabel lblYouWin = new JLabel("Game Over", SwingConstants.CENTER);
		lblYouWin.setFont(new Font("URW Gothic L", Font.BOLD, 50));
		lblYouWin.setForeground(new Color(255, 255, 255));
		
		JLabel lblCongratsYouCollected = new JLabel(message, SwingConstants.CENTER);
